...
/**
 * __useTopPagePostsQuery__
 *
 * To run a query within a React component, call `useTopPagePostsQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopPagePostsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useTopPagePostsQuery(baseOptions?: Apollo.QueryHookOptions<TopPagePostsQuery, TopPagePostsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TopPagePostsQuery, TopPagePostsQueryVariables>(TopPagePostsDocument, options);
      }
export function useTopPagePostsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TopPagePostsQuery, TopPagePostsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TopPagePostsQuery, TopPagePostsQueryVariables>(TopPagePostsDocument, options);
        }
export type TopPagePostsQueryHookResult = ReturnType<typeof useTopPagePostsQuery>;
export type TopPagePostsLazyQueryHookResult = ReturnType<typeof useTopPagePostsLazyQuery>;
export type TopPagePostsQueryResult = Apollo.QueryResult<TopPagePostsQuery, TopPagePostsQueryVariables>;